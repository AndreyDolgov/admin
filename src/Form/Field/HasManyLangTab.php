...
/**
 * Class HasManyLangTub.
 */
class HasManyLangTab extends Field
{
    /**
     * Relation name.
     *
    ...
    protected $views = [
        ...
        'langTab'   => 'admin::form.hasmanylangtab',
    ];
...
EOT;
    ...
    protected function setupScriptForLangTabView($templateScript)
    {
        $removeClass = NestedForm::REMOVE_FLAG_CLASS;
        $defaultKey = NestedForm::DEFAULT_KEY_NAME;
...
EOT;
    ...
    public function render()
    {
        ...
        list($template, $script,$template_fields) = $this->buildNestedForm($this->column, $this->builder)
