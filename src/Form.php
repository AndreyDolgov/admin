 ...
 * @method Field\HasManyNestable   hasManyNestable($relationName, $callback)
 * @method Field\HasManyLangTab    hasManyLangTab($relationName, $callback)
 * @method Field\HasManyRateOption hasManyRateOption($relationName, $callback)
...
//        static::doNotSnakeAttributes($this->model);
    ...
    public static function registerBuiltinFields()
    {
        $map = [
            ...
            'hasManyNestable'   => Field\HasManyNestable::class,
            'hasManyLangTab'    => Field\HasManyLangTab::class,
            'hasManyRateOption' => Field\HasManyRateOption::class,
